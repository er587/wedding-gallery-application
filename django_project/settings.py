...
env = environ.Env(
    DEBUG=(bool, False),
    SECRET_KEY=(str, ''),
    ALLOWED_HOSTS=(list, ['reneeanderic.wedding', 'www.reneeanderic.wedding', 'localhost', '127.0.0.1']),
    CSRF_TRUSTED_ORIGINS=(list, ['https://reneeanderic.wedding', 'https://www.reneeanderic.wedding']),
    CORS_ALLOWED_ORIGINS=(list, ['https://reneeanderic.wedding', 'https://www.reneeanderic.wedding']),
    ...
    FRONTEND_URL=(str, 'https://reneeanderic.wedding'),
